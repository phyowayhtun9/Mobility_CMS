<div id="contact" class="text-center">
  <div class="container">
    <div class="section-title black">
      <h2>{!!getcong_service('section_contact_title')!!}</h2>
      <hr>
    </div>
    <div class="col-md-6">
      <div class="col-md-12 contact"> <i class="fa fa-map-marker fa-2x"></i>
        <p class="dark">{!!getcong_service('section_contact_address')!!}</p>
      </div>
      <div class="col-md-12 contact"> <i class="fa fa-envelope-o fa-2x"></i>
        <p class="dark">{{getcong_service('section_contact_email1')}} <br>{{getcong_service('section_contact_email2')}}</p>
      </div>
      <div class="col-md-12 contact"> <i class="fa fa-phone fa-2x"></i>
        <p class="dark">{{getcong_service('section_contact_phone1')}} <br>{{getcong_service('section_contact_phone2')}}</p>
      </div>
      <hr>
...
$('#name').focus(function() {
    ...
    {!! Form::open(array('url' => 'contact_send','class'=>'','name'=>'sentMessage','id'=>'contactForm','role'=>'form')) !!}
    <div class="row">
