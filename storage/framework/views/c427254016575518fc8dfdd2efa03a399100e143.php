<footer>
    <div class="container">
      <ul class="row">
        <li class="col-sm-4">
          <h5><?php echo e(getcong_widgets('footer_widget1_title')); ?></h5>
          <hr>
          <p><?php echo getcong_widgets('footer_widget1_desc'); ?></p>
        ...
        <li class="col-sm-4">
          <h5><?php echo e(getcong_widgets('footer_widget2_title')); ?></h5>
          <hr>
          <?php echo getcong_widgets('footer_widget2_desc'); ?>

        </li>
        <li class="col-sm-4">
          <h5><?php echo e(getcong_widgets('footer_widget3_title')); ?></h5>
          <hr>
          <div class="loc-info">
            <p><i class="fa fa-map-marker"></i><?php echo getcong_widgets('footer_widget3_address'); ?></p>
