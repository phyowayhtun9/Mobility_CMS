        ...
        <div role="tabpanel" class="tab-pane active" id="service">             
            <?php echo Form::open(array('url' => 'admin/service_section','class'=>'form-horizontal padding-15','name'=>'service_form','id'=>'service_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="section_service_desc" class="form-control" rows="5" placeholder="A few words about service"><?php echo e($sections->section_service_desc); ?></textarea>
                    </div>
                </div>
        ...
        <div role="tabpanel" class="tab-pane" id="achivement">
            ...
            <?php echo Form::open(array('url' => 'admin/achivement_section','class'=>'form-horizontal padding-15','name'=>'achivement_form','id'=>'achivement_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Section Title</label>
                    <div class="col-sm-9">
                        <input type="text" name="section_achivement_title" value="<?php echo e($sections->section_achivement_title); ?>" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Block1 Icon</label>
                    <div class="col-sm-2">
                        <input type="text" name="section_achivement_block1_icon" value="<?php echo e($sections->section_achivement_block1_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_achivement_block2_icon" value="<?php echo e($sections->section_achivement_block2_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_achivement_block3_icon" value="<?php echo e($sections->section_achivement_block3_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_achivement_block4_icon" value="<?php echo e($sections->section_achivement_block4_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
        ...
        <div role="tabpanel" class="tab-pane" id="team">
            ...
            <?php echo Form::open(array('url' => 'admin/team_section','class'=>'form-horizontal padding-15','name'=>'team_form','id'=>'team_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Description</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="section_team_desc" class="form-control" rows="5" placeholder="A few words about team"><?php echo e($sections->section_team_desc); ?></textarea>
                    </div>
                </div> 
                  <hr>
                <div class="form-group">
        ...
        <div role="tabpanel" class="tab-pane" id="features">
            ...
            <?php echo Form::open(array('url' => 'admin/features_section','class'=>'form-horizontal padding-15','name'=>'features_form','id'=>'features_form','role'=>'form','enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Description</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="section_features_desc" class="form-control" rows="5" placeholder="A few words"><?php echo e($sections->section_features_desc); ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                                ...
                                <?php if($sections->section_features_image): ?>
                                 
                                    <img src="<?php echo e(URL::asset('upload/'.$sections->section_features_image)); ?>" width="150" alt="person">
                                <?php endif; ?>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features1_icon" value="<?php echo e($sections->section_features1_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features2_icon" value="<?php echo e($sections->section_features2_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features3_icon" value="<?php echo e($sections->section_features3_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features4_icon" value="<?php echo e($sections->section_features4_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features5_icon" value="<?php echo e($sections->section_features5_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input type="text" name="section_features6_icon" value="<?php echo e($sections->section_features6_icon); ?>" class="form-control" value="" placeholder="fa-smile-o">
                        <small class="text-muted bold"><a href="http://fontawesome.io/cheatsheet/" Target="_blank">Font Awesome Icon</a></small>
                    </div>
